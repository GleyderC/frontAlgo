...
<div class="page-header-top">
    <div class="container">
        ...
        <div class="page-logo">
            <a href="#/dashboard">
                <img src="assets/layouts/layout3/img/logo-collateral.png" alt="logo" class="logo-default" width="280px">
            </a>
        </div>
        <!-- END LOGO -->
        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-user dropdown-dark">
                    <a href="javascript:;" class="dropdown-toggle" dropdown-menu-hover data-toggle="dropdown"
                       data-close-others="true">
                        <img alt="" class="img-circle" src="assets/global/img/avatar.png" width="40px">
    ...
    <div class="container">
        ...
        <!-- DOC: Remove dropdown-menu-hover and data-close-others="true" attributes below to disable the dropdown opening on mouse hover -->
            ...
            <div class="nav-collapse collapse navbar-collapse navbar-responsive-collapse">
                <ul class="nav navbar-nav menu-sub-tab">
