		...
		.controller(
				...
				[
						...
						function($scope, $document, $timeout, $request,
							...
							$scope.setCurrentMarginCall = function(
									MarginCallEntity) {
							...
							$scope.onResponse = function(data) {
								...
								data.dataResponse
										.forEach(function(v, k) {
											...
											if (v.contract
													.hasOwnProperty("contractType")) {
												if (v.contract.contractType
														.toUpperCase() === "BILATERAL") {
													let
							...
							MarginCallService.getByDate(
									moment().format("YYYY-MM-DD")).success(
									function(data) {
										$scope.onResponse(data);
									});
				...
				[
						...
						function($scope, $compile, $timeout, $localStorage) {
							...
							$scope.showModal = function() {
								...
								$scope.listOfTypes.forEach(function(
										contractType) {
