...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Collateral | Dashboard</title>
        ...
        <div class="page-header">
            ...
            <div class="page-header-top">
                <div class="container">
                    ...
                    <div class="page-logo">
                        <a href="index.jsp">
                            <img src="../../../assets/layouts/layout3/img/logo-collateral.png" alt="logo" class="logo-default" width="240px" height="auto">
                        </a>
                    </div>
                    <!-- END LOGO -->
