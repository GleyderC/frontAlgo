...
angular.module('CollateralApp').controller('DashboardController',
    [
        ...
        'UserMessageService',
        'stompService',
        function ($rootScope, $scope, $request, toastr, $timeout, localStorageService, $menuService, ModalService, UserMessage,stompService) {
            ...
            $scope.Messages = [];
            stompService.receive().then(null, null,function(message){
            	  var newMessage = {};
                  newMessage = message; 
